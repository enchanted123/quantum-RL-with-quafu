...
from misc.utils import get_quafu_exp, get_obs_policy
...
if __name__ == "__main__":
    ...
    frames[1].save('./visualization/test2.gif', save_all=True, append_images=frames[2:], optimize=False, duration=40, loop=0)